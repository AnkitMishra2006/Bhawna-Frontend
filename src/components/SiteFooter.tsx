      ...
      <div className="max-w-[1200px] mx-auto px-6 py-16 grid grid-cols-2 md:grid-cols-5 gap-10">
        <div className="col-span-2 md:col-span-2 space-y-4">
          <div className="flex items-center gap-2.5">
            <span className="flex items-center justify-center w-9 h-9 rounded-xl overflow-hidden ring-1 ring-border">
              <img src={logo} alt="EmotionTrack logo" className="w-full h-full object-cover scale-110" width={36} height={36} loading="lazy" />
            </span>
            <span className="font-serif text-2xl">EmotionTrack</span>
          </div>
      ...
      <div className="border-t border-border">
        <div className="max-w-[1200px] mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} EmotionTrack. Frames processed locally — never stored.
          </p>
